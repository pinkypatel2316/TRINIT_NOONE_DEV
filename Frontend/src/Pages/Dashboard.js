...
function Dashboard() {
  ...
  const getTeacher = () => {
    axios.get(baseUrl + "addstudents").then((res) => {
      setCourseData(res.data.data.filter((i) => i.type === "teacher"));
    });
  };
  const teacherid = courseData.filter(
    (i) => (i.specialization === courseName) & (i.name === teacherName)
  )[0]?._id;
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  height:
                    ((showDiv === true) & (type === "teacher") ? 37.5 : 0) ||
                    ((showDiv === true) & (type !== "teacher") ? 150 : 0),
                  transition: "0.5s",
                  overflow: "hidden",
                  width: "50%",
                  backgroundColor: "white",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <option>
                      Develop Artificial Intelligence professional
                    </option>
